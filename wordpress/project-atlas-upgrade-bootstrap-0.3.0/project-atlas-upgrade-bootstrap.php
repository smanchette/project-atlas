 ...
 * Description: Single-purpose authenticated bootstrap for the fixed Metadata Bridge 0.57.6 to 0.57.7 replacement.
 * Version: 0.3.0
...
const ATLAS_UPGRADE_BOOTSTRAP_VERSION = '0.3.0';
const ATLAS_UPGRADE_BOOTSTRAP_ROUTE_NAMESPACE = 'project-atlas-deployment/v1';
const ATLAS_UPGRADE_BOOTSTRAP_ROUTE = '/metadata-bridge/upgrade-0577';
const ATLAS_UPGRADE_BOOTSTRAP_STATUS_ROUTE = '/metadata-bridge/upgrade-0577/status';
const ATLAS_UPGRADE_BOOTSTRAP_TARGET_PLUGIN = 'project-atlas-metadata-bridge/project-atlas-metadata-bridge.php';
const ATLAS_UPGRADE_BOOTSTRAP_CURRENT_VERSION = '0.57.6';
const ATLAS_UPGRADE_BOOTSTRAP_TARGET_VERSION = '0.57.7';
const ATLAS_UPGRADE_BOOTSTRAP_TARGET_ZIP = 'project-atlas-metadata-bridge-0.57.7.zip';
const ATLAS_UPGRADE_BOOTSTRAP_TARGET_ZIP_SHA256 = 'ada4d97ea627a148d07fda809c1776a91a87d7a7e4957de3bece423a9bb80a62';
const ATLAS_UPGRADE_BOOTSTRAP_TARGET_ENTRY_SHA256 = '3ee9c323103190e182970ee71631720814cc1d3590629fefb1f044cb6b1bcc5f';
const ATLAS_UPGRADE_BOOTSTRAP_TARGET_README_SHA256 = '6bce8d206ef1670eb57f0b7039885d754cd2537714f5cdb396b58f0a8eb20881';
...
function atlas_upgrade_bootstrap_apply(WP_REST_Request $request)
{
    ...
    if (
        ...
        return new WP_Error('atlas_current_state_mismatch', 'Metadata Bridge must be active at exactly version 0.57.6.', ['status' => 409]);
    }
