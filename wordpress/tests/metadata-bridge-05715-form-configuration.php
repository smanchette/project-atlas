...
/**
 * Process-local contract proof for the Metadata Bridge 0.57.15 private form
 * configuration surface. All addresses are synthetic fixtures.
 *
 * Usage:
 *   php wordpress/tests/metadata-bridge-05715-form-configuration.php
 */
...
function atlas_performance_local_v5_page_payload_apply(
    ...
    $response = [
        ...
        'metadata_bridge_version' => '0.57.15',
...
try {
    $module = dirname(__DIR__)
        . '/project-atlas-metadata-bridge-0.57.15/includes/performance-local-v5-form-delivery.php';
