...
def _activation_reconciliation_inspect(session, request, audit):
    ...
    gates = [
        _gate(
            ...
            runtime_exact
            and release.get("atlas_version") == "v0.59.96",
        ...
        _gate(
            ...
            and request.repository_tag == "v0.59.96"
...
def _activation_reconciliation_backup(request, release, audit):
    ...
    gates = [
        ...
        _gate(
            ...
            "Atlas Data backup predates the loaded v0.59.96 runtime or has a mismatched timestamp.",
        ),
        _gate(
