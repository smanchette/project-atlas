...
def test_backup_export_contains_metadata_counts_and_all_data_groups(tmp_path: Path) -> None:
    ...
    assert payload["metadata"]["version"] == "0.42"
...
def test_backup_restore_preserves_page_revisions_idempotently(tmp_path: Path) -> None:
    ...
    assert payload_json["metadata"]["version"] == "0.42"
...
def test_wordpress_api_exposes_only_controlled_publish_and_existing_write_routes() -> None:
    ...
    assert write_routes == {
        ...
        ("/api/wordpress/metadata/reconciliation/apply/{page_id}", "POST"),
            ...
            ("/api/wordpress/metadata/rendering/preflight/{page_id}", "POST"),
                ...
                ("/api/wordpress/metadata/rendering/cache-aware/preflight/{page_id}", "POST"),
                ("/api/wordpress/metadata/rendering/cache-aware/apply/{page_id}", "POST"),
                ("/api/wordpress/cache/siteground/preflight/{page_id}", "POST"),
                ("/api/wordpress/cache/siteground/apply/{page_id}", "POST"),
            ...
            ("/api/wordpress/deployment/metadata-bridge/install/reconciliation/verify/{page_id}", "POST"),
                ("/api/wordpress/deployment/metadata-bridge/install/reconciliation/apply/{page_id}", "POST"),
                    ...
                    ("/api/wordpress/deployment/metadata-bridge/upgrade/apply/{page_id}", "POST"),
                        ...
                        ("/api/wordpress/deployment/metadata-bridge/upgrade/reconciliation/preflight/{page_id}", "POST"),
                        ("/api/wordpress/deployment/metadata-bridge/upgrade/reconciliation/apply/{page_id}", "POST"),
                        ...
                        ("/api/wordpress/deployment/upgrade-bootstrap/activation/apply/{page_id}", "POST"),
                        ("/api/wordpress/deployment/upgrade-bootstrap/recovery/assess/{page_id}", "POST"),
                        ("/api/wordpress/deployment/upgrade-bootstrap/recovery/reconciliation/preflight/{page_id}", "POST"),
                        ("/api/wordpress/deployment/upgrade-bootstrap/recovery/reconciliation/apply/{page_id}", "POST"),
                    ("/api/wordpress/deployment/upgrade-bootstrap/cleanup/preflight/{page_id}", "POST"),
                    ("/api/wordpress/deployment/upgrade-bootstrap/cleanup/deactivate/{page_id}", "POST"),
                    ("/api/wordpress/deployment/upgrade-bootstrap/cleanup/delete/preflight/{page_id}", "POST"),
                    ("/api/wordpress/deployment/upgrade-bootstrap/cleanup/delete/apply/{page_id}", "POST"),
    ...
    allowed_delete_routes = {
        "/api/wordpress/deployment/upgrade-bootstrap/cleanup/delete/preflight/{page_id}",
        "/api/wordpress/deployment/upgrade-bootstrap/cleanup/delete/apply/{page_id}",
    }
    assert not any("bulk" in path.lower() for path, _ in wordpress_routes)
    assert not any("delete" in path.lower() and path not in allowed_delete_routes for path, _ in wordpress_routes)
    assert not any(method == "DELETE" for _, method in wordpress_routes)
    assert not any(
